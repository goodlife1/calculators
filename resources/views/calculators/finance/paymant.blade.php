    ...
    <div class="container-fluid">
        <div class="col-xs-12 col-md-9 ">
            ...
            <div class="col-md-6 calc-form">
                <form id="mortgage" action="finance/paymant" class="col-md-4" method="post" style="margin-top: 15px">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="amount">@lang('mortgage.loan amount')</label>
                    ...
                    <div class="form-group">
                        ...
                        <input value="6.5" type="number" placeholder="%" class="form-controll" id="rate" name="rate">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10 col-md-offset-1 table-shadule">
                            ...
                            <table class="table table-bordered" style="margin-top: 20px; color: black">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('mortgage.principal')</th>
                                    <th>@lang('mortgage.ending balance')</th>
                                    <th>@lang('mortgage.totalInterest')</th>
                                </tr>
                                </thead>
    ...
    $(document).ready(function () {
        ...
        function chart(data1) {
            ...
            var area = new Morris.Line({
                ...
                data: data1,
                xkey: 'year',
                ykeys: ['endingBalance', 'interest', 'principal'],
                labels: ['@lang('mortgage.ending balance')', '@lang('mortgage.interest')', '@lang('mortgage.principal')'],
...
`);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#total_loan_payment').html(data.total_paymants.toLocaleString());
        ...
        function createYearShadule(data) {
            ...
            for(let item in data){
                table+=` <tr>
                                    ...
                                    <td>${data[item].startingBalance}</td>
                                    <td>${data[item].interest}</td>
                                    <td>${data[item].principal}</td>
                                    <td>${data[item].endingBalance}</td>
                       </tr>`;
            }
        ...
        function createMontlyShadule(data) {
            ...
            for(let item in data){
                table+=` <tr>
                                    <td>${data[item].month}</td>
                                    <td>${data[item].startingBalance}</td>
                                    <td>${data[item].interest}</td>
                                    <td>${data[item].principal}</td>
                                    <td>${data[item].endingBalance}</td>
                                    <td>${data[item].totalInterest}</td>
                       </tr>`;
            }
